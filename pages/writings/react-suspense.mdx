import { ArticleHeading } from "../../src/components/writings";

<ArticleHeading title="React Suspense" />
...
_(If you’re curious, the real code is [here](https://github.com/facebook/react/blob/master/packages/react-reconciler/src/ReactFiberHooks.js).)_
